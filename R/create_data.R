...
#' @param ncores `integer`. Number of processing cores to be used when reading and merging CSV files in parallel. To disable parallelization, set `ncores = 1`. The default is 1.
...
#' @export
create_data = function(file.path, Start_date, End_Date, ncores = 1, max.na = NULL) {
